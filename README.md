...
**package require tomcrypt** ?0.5.2?
...
RUN wget https://github.com/cyanogilvie/tcl-tomcrypt/releases/download/v0.5.2/tcl-tomcrypt-v0.5.2.tar.gz -O - | tar xz --strip-components=1 && \
